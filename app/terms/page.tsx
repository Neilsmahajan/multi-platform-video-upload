      ...
      <main className="max-w-3xl mx-auto py-8 px-4 font-sans">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            across multiple video platforms. We also provide additional
            supporting services as described on our website.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            complies with all applicable laws and regulations. You must not use
            our service for any unlawful purposes.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            All content provided on or through our service is the property of
            its respective owners. Unauthorized use of any material may violate
            copyright laws.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            Any changes will be posted on this page and will become effective
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            contact us at multiplatformvideoupload@gmail.com.
          </p>
        </section>
      </main>
    </>
