  ...
  return (
    <main className="max-w-3xl mx-auto py-8 px-4 font-sans">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Welcome to Multiplatform Video Upload. We provide a simple way for you
          to upload a short video that can be distributed automatically to
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          your video uploads and usage information through NextAuth.js when you
          sign in.
        </p>
        <p className="mb-4">
          Our application uses Neon database and Prisma for data management. Any
          data stored is solely used for processing your video uploads and
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We do not sell or rent your personal information. Your data is shared
          with the video platforms (YouTube, Instagram Reels, and TikTok) solely
          for the purpose of uploading and publishing your video. In addition,
          trusted third parties (such as our authentication and database
          providers) process your data in accordance with our policies.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          material changes, we will update the effective date and notify you by
