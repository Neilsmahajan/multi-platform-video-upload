                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      This will be used as the default for all platforms. You
                      can customize per platform in the tabs.
                    </p>
                  </div>
                </div>
              </CardContent>
                  ...
                  <TabsContent value="instagram" className="space-y-4">
                    ...
                    <Alert className="bg-amber-50 border-amber-200">
                      ...
                      <AlertDescription className="text-amber-700">
                        Please connect your Instagram account in the dashboard
                        to enable posting to Reels.
                      </AlertDescription>
                    </Alert>
                  </TabsContent>
